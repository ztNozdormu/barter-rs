...
// }
//
// impl<Clock, ExecutionTxs: ExecutionTxMap<ExchangeIndex, InstrumentIndex>, Strategy, Risk> TradingRobot <Clock,ExecutionTxs, Strategy, Risk>
// // where
// // // MarketState: MarketDataState,
// //     Clock: EngineClock,//+ for<'a> Processor<&'a EngineEvent<MarketState::EventKind>>,
// //     ExecutionTxs: ExecutionTxMap<ExchangeIndex, InstrumentIndex>,
// //     Strategy:
// //     ClosePositionsStrategy<State = MyEngineState>,
// //     Risk: RiskManager,
// where
//     ExecutionTxs: ExecutionTxMap<ExchangeIndex, InstrumentIndex>,
// {
