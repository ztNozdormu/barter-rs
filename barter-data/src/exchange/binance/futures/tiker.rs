...
pub struct BinanceFuturesTiker {
    #[serde(
        alias = "s",
...
impl Identifier<Option<SubscriptionId>> for BinanceFuturesTiker {
...
pub struct BinanceFuturesTikerUpdater {
    pub updates_processed: u64,
    pub last_update_id: u64,
}

impl BinanceFuturesTikerUpdater {
    ...
    pub fn validate_first_update(
        &self,
        update: &BinanceFuturesTikerUpdater,
    ) -> Result<(), DataError> {
...
// #[async_trait]
// impl OrderBookUpdater for BinanceFuturesTikerUpdater {
